...
package com.botscrew.botframework.plivo.domain.action;
...
@Getter
@ToString
public class GetEvent implements PlivoAction {

    private final PlivoIncomingRequest plivoIncomingRequest;
    private final PlivoUser plivoUser;

    public GetEvent(PlivoIncomingRequest plivoIncomingRequest, PlivoUser plivoUser) {
